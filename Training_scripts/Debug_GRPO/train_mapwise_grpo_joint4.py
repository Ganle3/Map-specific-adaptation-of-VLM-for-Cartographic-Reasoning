"""Four-QA joint diagnostic: raw base, 120 updates, constant learning rate.
...
def main():
    ...
    def config(**kwargs):
        kwargs.update(max_steps=extra.max_steps, num_iterations=1, lr_scheduler_type='constant', warmup_steps=0)
