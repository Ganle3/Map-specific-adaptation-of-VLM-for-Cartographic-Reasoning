...
# -*- coding: utf-8 -*-
"""
Diagnose whether the FRIEDA training split provides useful GRPO signal.

The script does NOT train the model. It:
...
def score_answer(
    ...
    *,
    ...
    if not str(prediction or "").strip():
        ...
        correct = canonical_cardinal(prediction) == canonical_cardinal(expected)
        method = "cardinal_canonical"
