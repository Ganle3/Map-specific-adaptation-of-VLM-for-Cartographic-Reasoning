...
- Native Transformers + PEFT only; no Unsloth.
...
def build_mapwise_prompt(question: str) -> str:
    """Use exactly the same prompt as formal GRPO training."""
    return f"""
...
def run_mapwise_inference(
    *,
    ...
    print("=" * 80)
    print("MAPWISE NATIVE VALIDATION INFERENCE")
    print("=" * 80)
    ...
    try:
        for absolute_index in range(start_index, end_index):
            ...
            try:
                ...
                prompt = build_mapwise_prompt(question)
